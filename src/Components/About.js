...
const About = () => {
    return (
        <div className="about-container">
            <h1>About Us</h1>
            <p>
                Welcome to OneStopShop, your number one source for all things
                [tv audio laptop mobile gaming appliances]. We're dedicated to
                giving you the very best of [tv audio laptop mobile gaming
                appliances], with a focus on quality, customer service, and
                uniqueness.
            </p>
            <p>
